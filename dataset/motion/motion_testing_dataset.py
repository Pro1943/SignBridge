...
options = HandLandmarkerOptions(
    ...
    num_hands=1,
    min_hand_detection_confidence=0.5,  # LOWER for motion
    min_tracking_confidence=0.5,        # LOWER for motion
)
    ...
    while True:
        ...
        if key in LABEL_MAP:
            ...
            for s in [3, 2, 1]:
                ...
                cv2.imshow("SignBridge Motion TEST", fc)
                cv2.waitKey(300)
            ...
            if len(seq) == SEQ_LEN:
                ...
                print(f"✅ Saved motion TEST sequence: {label}")
            else:
